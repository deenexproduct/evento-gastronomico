  ...
  <section id="detras" class="border-b border-linea py-seccion">
    <div class="contenedor">
      ...
      <p class="lectura mt-5 text-[17px] text-gris">
        SaboresTech lo organiza <strong class="font-bold">Deenex</strong>, la plataforma
      ...
      <p class="lectura mt-4 text-[17px] text-gris">
        ...
        grandes tomadas con información que nadie mira, y nadie con quién contrastarlas. SaboresTech
